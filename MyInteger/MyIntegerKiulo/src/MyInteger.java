public class MyInteger {
    ...
    //Class fields are always private
    private int value;
    ...
    // Return true is the value in this object is equal to the specified value.
    ...
    // converts an array of numeric haracters to an int value
    public static int parseInt(char[] chars) {
        int value = 0;
        for (int i = 0, j = (int)Math.pow(10, chars.length - 1);
             i < chars.length; i++, j = j / 10) {
            value += (chars[i]- 48) * j;
        }
        return value;
    }
